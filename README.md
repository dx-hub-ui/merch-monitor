...
- **Locale-aware price parsing**: crawler price normalisation copes with comma decimal separators (for example `€12,34` or `€1.234,56`) so EU marketplace listings are stored with accurate cent values.
